...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="https://fonts.googleapis.com/css?family=Titillium+Web:400,300,600,700,400italic&subset=latin-ext"/>
...
<div class="main">
    ...
    <div class="content">
        ...
        <form action="nutello_send.php" method="post">
            <div class="form-horizontal">
                <textarea class="editor" rows="5" name="msg"></textarea>
                <button type="submit" class="btn btn-primary"><span class="glyphicon glyphicon-envelope"
                                                                    aria-hidden="true"> </span> Abschicken
                </button>
            </div>
        </form>
    </div>
    ...
    <div class="footer">
        <span>Anonyme Dingsbox für das Nu<br/>
            Gelitten unter <a href="https://php.net/">PHP</a></span>
    </div>
</div>
<script type="text/javascript">
